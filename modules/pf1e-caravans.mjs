...
Hooks.once('libWrapper.Ready', () => {
    ...
    if (pf1.applications?.item?.CreateDialog?.prototype?.getSubtypes) libWrapper.register(MODULE_ID, "pf1.applications.item.CreateDialog.prototype.getSubtypes", function (wrapper, type) {
        switch (type) {
